...
all :  BateauTest.out JoueurTest.out PartieTest.out main.out
...
BateauTest.o: BateauTest.cpp Bateau.hpp
...
JoueurTest.o: JoueurTest.cpp Joueur.hpp
...
PartieTest.o: PartieTest.cpp Partie.hpp
...
PartieTest.out: PartieTest.o Partie.o
	g++ $(CPP_FLAGS) -o PartieTest.out PartieTest.o Partie.o -lpthread $(GTEST_LIB)/libgtest.a $(GTEST_LIB)/libgtest_main.a


main.o: main.cpp 
	g++ -c $(CPP_FLAGS) main.cpp

main.out: main.o Partie.o Joueur.o Bateau.o
	g++ $(CPP_FLAGS) -o main.out main.o Partie.o Joueur.o Bateau.o -lpthread $(GTEST_LIB)/libgtest.a $(GTEST_LIB)/libgtest_main.a
